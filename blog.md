...
-sdg_11_60_page_linear.csv (Recycling rate of municipal waste in %)
-cei_pc031_page_linear.csv (Generation of municipal waste per capita in kg)
-demo_pjan__custom_5181490_page_linear.csv (Population)
